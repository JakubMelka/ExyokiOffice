...
static void PrintUsage(FILE *out)
{
    fprintf(out,
            ...
            "No network\n"
            "\n"
            "Nothing in this image opens a socket, so add --network none to every one\n"
            "of the commands above and to the args of every client entry. It costs\n"
            "nothing, starts faster, and leaves the container nowhere to send anything.\n"
            "\n"
