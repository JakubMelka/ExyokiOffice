...
public:
    ...
    [[nodiscard]] static bool IsWordprocessingNode(const Pugi::xml_node& node)
    {
    ...
    [[nodiscard]] static bool VanishInEffect(const Pugi::xml_node& vanish)
    {
    ...
    [[nodiscard]] static bool IsHiddenRun(const Pugi::xml_node& run)
    {
    ...
    static void ScrubWordNode(Pugi::xml_node node, bool removeCommentMarkers, bool removeHiddenRuns,
