...
/// File-local report emission helpers for the command line.
class ExyokiReportHelper
{
public:
    ...
    static std::string RenderReport(const ReportDocument& document, const std::string& format)
    {
        if (format == "json")
        {
    ...
    static void EmitReport(const ReportDocument& document, const GlobalOptions& options)
    {
...
int main(int argc, char** argv)
{
    ...
    ExyokiReportHelper::GlobalOptions options;
    ...
    // parts
    std::string partsPackage;
    std::string partsSort = "uri";
    ...
    // relationships
    std::string relPackage;
    std::vector<std::string> relParts;
    bool relDanglingOnly = false;
    ...
    std::string propsSetPackage;
    std::string propsSetTitle;
    std::string propsSetCreator;
    std::string propsSetSubject;
    std::string propsSetKeywords;
    std::vector<std::string> propsSetCustom;
    std::string propsSetOutput;
    ...
    // validate
    std::vector<std::string> validatePackages;
    std::string validateVersion = "365";
    bool validateNoDom = false;
    bool validateCrossCheck = false;
    int validateMaxIssues = -1;
    bool validateErrorsOnly = false;
    bool validateWarningsAsErrors = false;
    ...
    // unpack
    std::string unpackPackage;
    std::string unpackOutDir;
    bool unpackPretty = false;
    bool unpackOverwrite = false;
    ...
    // pack
    std::string packInDir;
    std::string packOutPackage;
    bool packRegenerateContentTypes = false;
    bool packValidate = false;
    int packCompression = 6;
    bool packOverwrite = false;
    ...
    std::string toFlatOpcPackage;
    std::string toFlatOpcOutFile;
    bool toFlatOpcNoPretty = false;
    ...
    std::string fromFlatOpcInFile;
    std::string fromFlatOpcPackage;
    int fromFlatOpcCompression = 6;
    ...
    std::string convertMediaDir;
    bool convertEmbedMedia = false;
    bool convertNoMedia = false;
    bool convertOverwrite = false;
    auto* convertCmd =
    ...
    std::string convertSheet;
    std::string convertCsvSeparator = ",";
    ...
    // export-media
    std::string mediaPackage;
    std::string mediaOutDir;
    bool mediaOverwrite = false;
    ...
    // dedup
    std::string dedupInput;
    std::string dedupOutput;
    bool dedupDryRun = false;
    bool dedupOverwrite = false;
    bool dedupFonts = false;
    bool dedupAllBinary = false;
    auto* dedupCmd =
    ...
    // search
    std::string searchPackage;
    std::string searchNeedle;
    int searchContext = 40;
    ...
    // query
    std::string queryPackage;
    std::string queryXpath;
    std::string queryPart;
    std::vector<std::string> queryNamespaces;
    int queryMax = 0;
    ...
    // replace
    std::string replacePackage;
    std::string replaceNeedle;
    std::string replaceReplacement;
    bool replaceDryRun = false;
    std::string replaceOutput;
    bool replaceIsRegex = false;
    bool replaceIgnoreCase = false;
    auto* replaceCmd =
    ...
    // split
    std::string splitPackage;
    std::string splitOutDir;
    std::string splitBy = "auto";
    ExyokiOffice::Size splitCount = 0;
    std::string splitMarker;
    std::string splitPrefix = "part";
    bool splitOverwrite = false;
    ...
    bool mergeNoPageBreaks = false;
    bool mergeOverwrite = false;
    std::string mergeStyleConflict = "rename";
    ...
    // diff
    std::string diffLeft;
    std::string diffRight;
    bool diffNoNormalize = false;
    bool diffPartsOnly = false;
    ...
    // compare
    std::string compareOriginal;
    std::string compareRevised;
    std::string compareOutput;
    std::string compareAuthor = "exyoki";
    auto* compareCmd =
    ...
    // redact
    std::string redactPackage;
    std::string redactOutput;
    bool redactKeepComments = false;
    bool redactKeepRevisions = false;
    bool redactKeepHidden = false;
    bool redactKeepMetadata = false;
    auto* redactCmd =
    ...
    // fill
    std::string fillPackage;
    std::string fillData;
    std::string fillOutput;
    auto* fillCmd =
    ...
    // recalc
    std::string recalcPackage;
    std::string recalcSheet;
    std::string recalcOutput;
    bool recalcDryRun = false;
    auto* recalcCmd =
    ...
    if (!ExyokiReportHelper::ApplyPackageLimits(options.PackageLimits, options.Quiet))
    {
    ...
    try
    {
        if (*commandsCmd)
        {
            ...
            ExyokiReportHelper::EmitReport(document, options);
        ...
        if (*partsCmd)
        {
            ...
            {
                ExyokiReportHelper::EmitReport(exyoki::AdaptParts({}, partsSort), options);
                return static_cast<int>(ExitCode::OperationFailed);
            }
            ExyokiReportHelper::EmitReport(exyoki::AdaptParts(ListParts(package), partsSort), options);
        ...
        if (*relCmd)
        {
            ...
            {
                ExyokiReportHelper::EmitReport(exyoki::AdaptRelationships({}, relDanglingOnly), options);
                return static_cast<int>(ExitCode::OperationFailed);
            }
            ...
            ExyokiReportHelper::EmitReport(exyoki::AdaptRelationships(relationships, relDanglingOnly), options);
            return static_cast<int>(ExitCode::Ok);
        }
        ...
        if (*infoCmd)
        {
            ...
            {
                ExyokiReportHelper::EmitReport(exyoki::AdaptInfo({}, infoPropsOnly), options);
                return static_cast<int>(ExitCode::OperationFailed);
            }
            ExyokiReportHelper::EmitReport(exyoki::AdaptInfo(GetInfo(package), infoPropsOnly), options);
            return static_cast<int>(ExitCode::Ok);
        }
        ...
        if (*propsGetCmd)
        {
            ...
            {
                ExyokiReportHelper::EmitReport(exyoki::AdaptPropsGet({}), options);
                return static_cast<int>(ExitCode::OperationFailed);
            }
            ExyokiReportHelper::EmitReport(exyoki::AdaptPropsGet(ReadCoreProperties(package)), options);
            return static_cast<int>(ExitCode::Ok);
        }
        ...
        if (*propsSetCmd)
        {
            ...
            {
                ExyokiReportHelper::EmitReport(exyoki::AdaptPropsSet(false, "", ""), options);
                return static_cast<int>(ExitCode::OperationFailed);
            }
            ...
            ExyokiReportHelper::EmitReport(exyoki::AdaptPropsSet(allOk, lastName, lastValue), options);
        ...
        if (*signaturesCmd)
        {
            ...
            ExyokiReportHelper::EmitReport(exyoki::AdaptSignatures(report), options);
        ...
        if (*externalCmd)
        {
            ...
            ExyokiReportHelper::EmitReport(exyoki::AdaptExternal(report), options);
        ...
        if (*unpackCmd)
        {
            ...
            ExyokiReportHelper::EmitReport(exyoki::AdaptUnpack(result), options);
        ...
        if (*packCmd)
        {
            ...
            ExyokiReportHelper::EmitReport(exyoki::AdaptPack(result), options);
            return result.Ok ? static_cast<int>(ExitCode::Ok) : static_cast<int>(ExitCode::OperationFailed);
        }
        ...
        if (*toFlatOpcCmd)
        {
            ...
            ExyokiReportHelper::EmitReport(exyoki::AdaptToFlatOpc(result), options);
            return result.Ok ? static_cast<int>(ExitCode::Ok) : static_cast<int>(ExitCode::OperationFailed);
        }
        ...
        if (*fromFlatOpcCmd)
        {
            ...
            ExyokiReportHelper::EmitReport(exyoki::AdaptFromFlatOpc(result), options);
            return result.Ok ? static_cast<int>(ExitCode::Ok) : static_cast<int>(ExitCode::OperationFailed);
        }
        ...
        if (*convertCmd)
        {
            ...
            ExyokiReportHelper::EmitReport(exyoki::AdaptConvert(result, convertInput, convertOutput), options);
            if (result.Ok)
            {
                return static_cast<int>(ExitCode::Ok);
            }
        ...
        if (*mediaCmd)
        {
            ...
            {
                ExyokiReportHelper::EmitReport(exyoki::AdaptExportMedia({}), options);
                return static_cast<int>(ExitCode::OperationFailed);
            }
            const auto result = ExportMedia(package, mediaOutDir, mediaOverwrite);
            ExyokiReportHelper::EmitReport(exyoki::AdaptExportMedia(result), options);
            return result.Ok ? static_cast<int>(ExitCode::Ok) : static_cast<int>(ExitCode::OperationFailed);
        }
        ...
        if (*dedupCmd)
        {
            ...
            ExyokiReportHelper::EmitReport(exyoki::AdaptDedup(result, dedupOptions.DryRun), options);
            return result.Ok ? static_cast<int>(ExitCode::Ok) : static_cast<int>(ExitCode::OperationFailed);
        }
        ...
        if (*queryCmd)
        {
            ...
            for (const auto& binding : queryNamespaces)
            {
                ...
                {
                    ExyokiReportHelper::EmitReport(exyoki::AdaptQuery([&]
                                                                      {
                               QueryResult invalid;
            ...
            ExyokiReportHelper::EmitReport(exyoki::AdaptQuery(result), options);
            if (!result.Ok)
            {
                return static_cast<int>(ExitCode::OperationFailed);
            }
        ...
        if (*searchCmd)
        {
            const auto result =
                SearchDocumentText(searchPackage, searchNeedle,
                                   ...
                                   searchIgnoreCase);
            ExyokiReportHelper::EmitReport(exyoki::AdaptSearch(result), options);
            if (!result.Ok)
            {
                return static_cast<int>(ExitCode::OperationFailed);
            }
        ...
        if (*extractCmd)
        {
            ...
            ExyokiReportHelper::EmitReport(exyoki::AdaptExtractText(result), options);
            return result.Ok ? static_cast<int>(ExitCode::Ok) : static_cast<int>(ExitCode::OperationFailed);
        }
        ...
        if (*statCmd)
        {
            ...
            ExyokiReportHelper::EmitReport(exyoki::AdaptStat(result), options);
            return result.Ok ? static_cast<int>(ExitCode::Ok) : static_cast<int>(ExitCode::OperationFailed);
        }
        ...
        if (*replaceCmd)
        {
            ...
            ExyokiReportHelper::EmitReport(exyoki::AdaptReplace(result), options);
            return result.Ok ? static_cast<int>(ExitCode::Ok) : static_cast<int>(ExitCode::OperationFailed);
        }
        ...
        if (*splitCmd)
        {
            ...
            ExyokiReportHelper::EmitReport(exyoki::AdaptSplit(result), options);
            return result.Ok ? static_cast<int>(ExitCode::Ok) : static_cast<int>(ExitCode::OperationFailed);
        }
        ...
        if (*mergeCmd)
        {
            ...
            ExyokiReportHelper::EmitReport(exyoki::AdaptMerge(result), options);
            return result.Ok ? static_cast<int>(ExitCode::Ok) : static_cast<int>(ExitCode::OperationFailed);
        }
        ...
        if (*diffCmd)
        {
            ...
            ExyokiReportHelper::EmitReport(exyoki::AdaptDiff(result, diffPartsOnly), options);
            if (!result.Ok)
            {
                return static_cast<int>(ExitCode::OperationFailed);
            }
        ...
        if (*compareCmd)
        {
            ...
            ExyokiReportHelper::EmitReport(exyoki::AdaptCompare(result), options);
            if (!result.Ok)
            {
                return static_cast<int>(ExitCode::OperationFailed);
            }
        ...
        if (*redactCmd)
        {
            ...
            ExyokiReportHelper::EmitReport(exyoki::AdaptRedact(result), options);
            return result.Ok ? static_cast<int>(ExitCode::Ok) : static_cast<int>(ExitCode::OperationFailed);
        }
        ...
        if (*fillCmd)
        {
            ...
            ExyokiReportHelper::EmitReport(exyoki::AdaptFill(result), options);
            return result.Ok ? static_cast<int>(ExitCode::Ok) : static_cast<int>(ExitCode::OperationFailed);
        }
        ...
        if (*recalcCmd)
        {
            ...
            ExyokiReportHelper::EmitReport(exyoki::AdaptRecalc(result), options);
            return result.Ok ? static_cast<int>(ExitCode::Ok) : static_cast<int>(ExitCode::OperationFailed);
        }
        ...
        if (*schemaCmd)
        {
            if (!schemaCheck.empty())
            {
                ...
                ExyokiReportHelper::EmitReport(exyoki::AdaptSchemaCheck(schemaCheck, valid, violations), options);
