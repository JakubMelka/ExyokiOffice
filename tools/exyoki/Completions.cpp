...
std::string GenerateBash(const CompletionModel& model)
{
    std::string script;
...
std::string GenerateZsh(const CompletionModel& model)
{
    std::string script;
...
std::string GeneratePowerShell(const CompletionModel& model)
{
    std::string script;
...
{
    const CompletionModel model(app);
    if (shell == "bash")
    {
