...
the ExyokiOffice project a harassment-free experience for everyone, regardless
...
- Giving and gracefully accepting constructive feedback. Review comments are
  about the change, not about the person who wrote it.
...
pull requests, discussions, and the commit history — and also when an
...
1. **Correction.** A private, written warning explaining the nature of the
